...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        limite_diario = valor > self.limite
        saques_excedidos = numero_saques >= self.limite_saques

        if limite_diario:
            print("\n### Operação falhou! O limite diário para saques é de R$ 500.00 ###")

        elif saques_excedidos:
            print("\n### Operação falhou! Excedeu o limite de 3 saques diários ###")
...
class Saque(Transacao):
    ...
    def registrar(self,conta):
        sucesso_transcao=conta.sacar(self.valor)
